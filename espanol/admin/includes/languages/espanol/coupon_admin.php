...
define('TEXT_TO_REDEEM1', 'Usted puede también redimir esta cupón del descuento durante la comprobación. Apenas introduzca el código en la caja proporcionada, y chasque encendido el botón del redimir.');
...
define('COUPON_SALE_EXCLUDE_HELP', 'Esta cupón no se aplica a ninguÌn artículo que se marque como estando en venta.');
define('COUPON_SALE_EXCLUSION', 'Exclusión de la venta de la cupón');
