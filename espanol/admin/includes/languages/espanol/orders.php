...
*/
define('TABLE_HEADING_EDIT_ORDERS', 'Para modificar la orden');

define('HEADING_TITLE', 'Pedidos');
define('HEADING_IS_TITLE', 'ES la orden');
define('HEADING_IS_RECEIPT', 'ES el recibo');
...
define('ENTRY_CREDIT_CARD_START','Vuelva al d& eacute; Hojas de los CB');
...
define('ENTRY_PAYMENT_TRANS_ID', 'Identificación de transacción: '); 
// Email Subject 
...
define('TABLE_HEADING_PRODUCTS_VENDOR', 'Vendedor');
define('TABLE_HEADING_QUANTITY', 'Qty');
define('TABLE_HEADING_VENDORS_SHIP', 'Expedidor');
define('TABLE_HEADING_SHIPPING_METHOD', 'Método');
define('TABLE_HEADING_SHIPPING_COST', 'Coste de la nave');
define('VENDOR_ORDER_SENT', 'Órdenes enviadas a ');
?>