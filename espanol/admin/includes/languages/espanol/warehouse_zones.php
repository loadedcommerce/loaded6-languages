<?php
/*
  $Id: warehouse_zones.php,v 1.2 2004/03/05 00:36:41 datazen Exp $
...
*/
define('HEADING_TITLE', 'Warehouse Zones');
define('TABLE_HEADING_COUNTRY', 'Country');
define('TABLE_HEADING_COUNTRY_ZONE', 'Zone');
define('TABLE_HEADING_TAX_ZONES', 'Warehouse Zones');
define('TABLE_HEADING_ACTION', 'Action');
define('TEXT_INFO_HEADING_NEW_ZONE', 'New Warehouse Zone');
define('TEXT_INFO_NEW_ZONE_INTRO', 'Please enter the new warehouse zone information');
define('TEXT_INFO_HEADING_EDIT_ZONE', 'Edit Warehouse Zone');
define('TEXT_INFO_EDIT_ZONE_INTRO', 'Please make any necessary changes');
define('TEXT_INFO_HEADING_DELETE_ZONE', 'Delete Warehouse Zone');
define('TEXT_INFO_DELETE_ZONE_INTRO', 'Are you sure you want to delete this warehouse zone?');
...
define('TEXT_INFO_ZONE_NAME', 'Warehouse Zone Name:');
define('TEXT_INFO_NUMBER_ZONES', 'Number of Warehouse Zones:');
...
define('TEXT_INFO_ZONE_ZIP_CODE', 'Zip Code:');
?>