...
define('HEADING_TITLE_GROUPS', 'Administrar grupos');
define('HEADING_TITLE_DEFINE', 'Set Menu and File Access by Group');
define('HEADING_TITLE_MEMBERS', 'Administrar miembros');
...
define('TEXT_INFO_DEFAULT_GROUPS_INTRO', '<b>NOTA:</b><ul><li><b>Editar:</b> editar el nombre del grupo.</li><li><b>Eliminar:</b> eliminar el grupo.</li><li><b>Definir:</b> definir el nivel de aceso del grupo.</li></ul>');
...
define('IMAGE_FILE_PERMISSIONS', 'Permisos del archivo'); 
?>
