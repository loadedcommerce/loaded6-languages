...
define('TEXT_PUSH_SUB_CATEGORIES','Push access to all Link categories');
define('TEXT_PUSH_SUB_CATEGORIES_PRODUCTS','Push access to all link categories and links');
define('TEXT_PUSH_WARNING','Warning : may time out if this is a top level and you have a large number of link categories and links');
?>
