...
define('TEXT_PUSH_SAVE_OPTION','Excepto opciones');
define('TEXT_PUSH_WARNING','Advertencia: la operación puede medir el tiempo hacia fuera si esto es un nivel superior y usted tiene una gran cantidad de productos.');
?>