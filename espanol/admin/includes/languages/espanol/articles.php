...
define('NEW_TEXT_ARTICLES_GROUP_ACCESS','Nuevo artículo');
define('EDIT_TEXT_ARTICLES_GROUP_ACCESS','Corrija el artículo');
define('TEXT_ARTICLES_GROUP_ACCESS','Acceso del grupo');
define('ARTICLES_GUEST', ' Huésped');
define('ARTICLES_SHOW', ' Demostración');
define('ARTICLES_HIDE', ' Piel');
...
define('TEXT_PUSH_SUB_CATEGORIES','Push access to all topics');
define('TEXT_PUSH_SUB_CATEGORIES_PRODUCTS','Push access to all topics and articles');
define('TEXT_PUSH_WARNING','Warning : may time out if this is a top level and you have a large number of topics and articles');
?>
