...
define('ERROR1', '¡Error! 01 el nombre de la plantilla no es iguales que el archivo de .sql o el archivo del sql no está presente');
define('ERROR3', '¡Error! 03 usted no puede instalar la plantilla del defecto, apesadumbrada');
