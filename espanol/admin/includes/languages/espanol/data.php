...
define('TEXT_RUN_CONFIGURE', 'Funcione configuran');
define('TEXT_FEED_RUN_PRE_FEED', 'Funcione con pre la alimentación');
define('TEXT_FEED_RUN_FEED', 'Someta la alimentación');
...
define('TEXT_INFO_FEED_MISSING', 'Si sus alimentaciones faltan del FUNCIONAMIENTO caiga abajo, FUNCIONAN por favor el & quot; Configure& quot; y cambie el servicio de la alimentación de Froogle a Google Base. El ftp server también ha cambiado.<br> Este mensaje apear mientras haya una alimentación con el servicio de la alimentación del & quot; froogle& quot; se almacena en la base de datos');
define('IMAGE_FEED_RUN', 'Someta la alimentación'); 
define('IMAGE_SET_CATEGORIES', 'Fije las categorías');
?>