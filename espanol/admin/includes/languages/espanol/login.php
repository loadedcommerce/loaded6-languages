...
define('TEXT_FORGOTTEN_SUPPORT_MESSAGE','Si usted necesita la ayuda que reajusta su email address o el recuperación de su contraseña entra en contacto con por favor su ayuda del webhost o la ayuda cargada CRE en <a href="http://www.creloaded.com/support/" style="color:#666;">www.CRELoaded.com/support/</a>'); 
define('TEXT_PASSWORD_FORGOTTEN_TITLE','Contraseña olvidada');
?>
