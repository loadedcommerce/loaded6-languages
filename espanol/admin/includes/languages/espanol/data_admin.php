...
define('TABLE_HEADING_FEED', '<b>Google Base FTP information</b>');
define('TABLE_HEADING_FEED_ADVANCE', '<b>Google Base Advance Settings</b>');
...
define('TABLE_HEADING_FEED_FTP_SERVER', 'Google Base FTP Server Name');
define('TABLE_HEADING_FEED_FTP_USER', 'Google Base FTP User Name');
define('TABLE_HEADING_FEED_FTP_PASSWORD', 'Google Base FTP Password');
define('TABLE_HEADING_FEED_FTP_DIRECTORY', 'Google Base FTP Directory');
...
define('TEXT_FEED_GOOGLE_BASE', 'Alimentación de Google Base');
define('TEXT_FEED_YAHOO', 'Yahoo Feed');
define('TEXT_FEED_FROOGLE', 'Change Me to Google Base');
...
define('TEXT_INFO_FEED_ADVANCE_ADDITION', 'Para más características y cualidad anticipadas, usted debe corregir manualmente el file" & quot; froogle_configure.php& quot;');
?>