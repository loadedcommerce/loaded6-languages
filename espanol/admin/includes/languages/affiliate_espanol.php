...
define('ENTRY_AFFILIATE_ACCEPT_AGB_TEXT', 'Condiciones del programa del afiliado ');
...
define('AFFILIATE_MALE', 'Varón');
define('AFFILIATE_FEMALE', 'Hembra');

//moved from espanol.php
