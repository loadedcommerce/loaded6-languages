...
define('NAVBAR_TITLE', 'Build an Affiliate Product Link');
define('HEADING_TITLE', 'Build an Affiliate Product Link');
...
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER','Construya un acoplamiento del producto del afiliado con imágenes o texto llano');
