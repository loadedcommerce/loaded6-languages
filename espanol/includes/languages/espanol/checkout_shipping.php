...
define('ERROR_VALID_TO_CHECKOUT', 'Ponga al día por favor su orden ...');

//MVS 
define('TEXT_MULTIPLE_SHIPPING_METHODS', 'Algunos productos serán enviados de diversas localizaciones. Elija por favor un método del envío para cada grupo de productos abajo.');
