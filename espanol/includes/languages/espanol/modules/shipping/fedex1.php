...
define('MODULE_SHIPPING_FEDEX1_TEXT_DESCRIPTION', 'FedEx<br><br>You will need to have registered an account with FEDEX to use this module. You will also need to have registered for access to ship manager direct and get added to the test server, and eventually, the production server.');
