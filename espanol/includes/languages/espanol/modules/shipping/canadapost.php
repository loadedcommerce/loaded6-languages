...
define('MODULE_SHIPPING_CANADAPOST_ERROR_1', 'Un error desconocido ocurrió con los cálculos del envío del canadapost.');
define('MODULE_SHIPPING_CANADAPOST_ERROR_2', '<br>Si usted prefiere utilizar el canadapost como su método del envío, entre en contacto con por favor a dueño del almacén.');
