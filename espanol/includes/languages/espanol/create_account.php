...
define('EMAIL_GREET_MR', 'Estimado ' . stripslashes($_POST['Apellido']) . ',' . "\n\n");
define('EMAIL_GREET_MS', 'Estimado ' . stripslashes($_POST['Apellido']) . ',' . "\n\n");
define('EMAIL_GREET_NONE', 'Estimado ' . stripslashes($_POST['Nombre']) . ',' . "\n\n");
...
define('HEADING_TITLE_CHECKOUT','Comprobación Info personal');// Added by sheetal for PWA form Title
