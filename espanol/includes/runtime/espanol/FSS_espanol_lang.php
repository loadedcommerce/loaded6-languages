<?php
/*
  $Id: FSS_espanol_lang.php,v 1.0.0 2008/05/22 13:41:11 Eversun Exp $
...
*/ 
define('FSS_ACCOUNT_UPDATE_WARNING', 'Ponga al día por favor su cuenta. Hemos realizado cambios a su perfil de cuenta que su atención es necesaria.');
define('FSS_HEADING_FORMS_AND_SURVEY', 'Mis formas y exámenes');
define('FSS_TEXT_UPDATE_ADDITIONAL_INFO', 'Ponga al día la información adicional sobre mi cuenta');
define('FSS_TEXT_UNCOMPLETED_SURVEYS', 'Encuestas sobre inacabadas la visión');
define('FSS_TEXT_COMPLETED_SURVEYS', 'Vea mis exámenes terminados');
