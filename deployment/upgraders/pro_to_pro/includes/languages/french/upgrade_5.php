...
define('TEXT_INSTALL_1', 'The configuration was successful!');
...
define('TEXT_CRE_MERCHANT_SKIP', 'Sautez cette &eacute;tape');
define('TEXT_CRE_MERCHANT_SKIP_CONFIRM_YES', 'Pas, je continuerai sans traitement par la carte de cr&eacute;dit');
define('TEXT_CRE_MERCHANT_SKIP_CONFIRM_NO', 'Attendez, je veulent s\'appliquer pour le n&eacute;gociant de CRE !');
