...
define('TEXT_CRE_MERCHANT_SKIP', '&Uuml;berspringen Sie den Schritt');
define('TEXT_CRE_MERCHANT_SKIP_CONFIRM_YES', 'Nicht fahre ich fort, ohne Kreditkartezu verarbeiten');
define('TEXT_CRE_MERCHANT_SKIP_CONFIRM_NO', 'Warten Sie, ich m&ouml;chten CRE Kaufmann beantragen!');
