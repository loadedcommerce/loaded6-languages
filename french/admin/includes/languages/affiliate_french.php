...
define('ENTRY_AFFILIATE_ACCEPT_AGB_TEXT', 'Termes et conditions générales de programme de filiale ');
...
define('ENTRY_AFFILIATE_COMPANY', 'compañía:');
...
define('CATEGORY_PAYMENT_DETAILS', 'Vous Passez Votre Argent');
...
define('AFFILIATE_MALE', 'Mâle');
define('AFFILIATE_FEMALE', 'Femelle');

//moved from french.php
