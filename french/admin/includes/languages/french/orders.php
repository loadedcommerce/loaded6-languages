...
*/
define('TABLE_HEADING_EDIT_ORDERS', 'Pour modifier l\'ordre');
define('ENTRY_CREDIT_CARD_START_DATE', 'Date de début : ');
define('HEADING_TITLE', 'Commandes');
define('HEADING_IS_TITLE', 'EST l\'ordre');
define('HEADING_IS_RECEIPT', 'EST le reçu');
...
define('ENTRY_PAYMENT_TRANS_ID', 'Id de transaction: ');  
// Email Subject 
...
define('TABLE_HEADING_PRODUCTS_VENDOR', 'Fournisseur');
define('TABLE_HEADING_QUANTITY', 'Quantité');
define('TABLE_HEADING_VENDORS_SHIP', 'Expéditeur');
define('TABLE_HEADING_SHIPPING_METHOD', 'Méthode');
define('TABLE_HEADING_SHIPPING_COST', 'Coût de bateau');
define('VENDOR_ORDER_SENT', 'Ordres envoyés à ');
?>