...
define('TITLE_PRINT_ORDER', 'Product Returns #: '); 
define('HEADING_TITLE', 'Product Returns');
...
define('TABLE_HEADING_DATE_PURCHASED', 'Return Date');
...
define('ENTRY_SHIPPING_ADDRESS', 'Domain name:');
define('ENTRY_BILLING_ADDRESS', 'Company name:');
...
define('TEXT_DATE_TIME', 'Return date: ');
...
define('TEXT_RETURN_COMMENT', 'Returns Comments');
define('TEXT_SHIPPING_ADRESS', 'Shipping Adress: ');
define('TEXT_BILLING_ADRESS', 'Billing Address: ');
define('TEXT_DECUSIONS', 'Deductions' );
define('TEXT_REFUND_AMOUNT', 'Refund Amount' );
define('TEXT_CUSTOM_PREF_METHOD','Customers Preference:');
?>
