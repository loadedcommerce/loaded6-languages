...
define('CROSS_SELL_SUCCESS', 'Les articles de Vente-X mettent à jour avec succès pour le produit de Vente-X  #'.(isset($_GET['add_related_product_ID']) ? $_GET['add_related_product_ID'] : 0));
define('SORT_CROSS_SELL_SUCCESS', 'L\'ordre de sorte mettent à jour avec succès pour le produit de Vente-X #'.(isset($_GET['add_related_product_ID']) ? $_GET['add_related_product_ID'] : 0));
