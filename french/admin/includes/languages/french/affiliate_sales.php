...
define('TEXT_DISPLAY_NUMBER_OF_SALES', 'Affichage de <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> ventes)');

define('TEXT_AFFILIATE_HEADER', 'Ventes provenant de votre site :');
define('TEXT_SALES_HELP', ' [?] ');
define('TEXT_SALES', 'Cliquer sur [?] pour voir une description de chaque cat&eacute;gorie.');
define('HEADING_SALES_HELP', 'Aide Partenaires');

    
define('TABLE_HEADING_AFFILIATE','Affiliation');
