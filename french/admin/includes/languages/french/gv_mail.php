...
define('TEXT_TO_REDEEM1', 'Vous pouvez également racheter ce bon de cadeau pendant le contrôle. Écrivez juste le code dans la boîte fournie, et cliquez sur dessus le bouton de rachat. ');
...
define('TEXT_REDEEM_COUPON_MESSAGE_HEADER', 'Vous avez récemment acheté un chèque-cadeau de notre magasin en ligne.' . "\n"
                                          . 'Pour des raisons de sécurité, ce n\'était pas immédiatement disponible pour vous.' . "\n"
                                          . 'Toutefois, ce montant a maintenant été remis en liberté. Vous pouvez maintenant visiter notre magasin' . "\n"
                                          . 'et la valeur envoyer par e-mail à quelqu\'un.' . "\n\n");
