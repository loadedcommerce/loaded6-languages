...
define('ERROR_DIRECTORY_NOT_WRITEABLE', 'Impossible d\'&eacute;crire dans ce r&eacute;pertoire. Merci de v&eacute;rifier les droits d\'acc&egrave;s sur: %s');
define('ERROR_FILE_NOT_WRITEABLE', 'Erreur : Impossible d\'&eacute;crire dans ce fichier. Merci de v&eacute;rifier les droits d\'acc&egrave;s sur : %s');
