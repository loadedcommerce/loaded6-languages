...
define('TEXT_FORGOTTEN_SUPPORT_MESSAGE','Si vous avez besoin d\'aide remettant à zéro votre email address ou la recherche de votre mot de passe entrent en contact avec svp votre appui de webhost ou appui chargé par CRE à <a href="http://www.creloaded.com/support/" target="_blank">www.creloaded.com/support/</a>');
...
define('TEXT_PASSWORD_FORGOTTEN_TITLE','Mot de passe oublié');
?>