...
define('TEXT_TO_REDEEM1', 'Vous pouvez également racheter ce bon d\'escompte pendant le contrôle. Écrivez juste le code dans la boîte fournie, et cliquez sur dessus le bouton de rachat.'); 
...
define('COUPON_SALE_EXCLUDE_HELP', 'Ce bon ne s\'applique à aucun article qui est marqué en tant qu\'étant en vente.');
define('COUPON_SALE_EXCLUSION', 'Exclusion de vente de bon');
