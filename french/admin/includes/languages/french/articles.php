...
define('NEW_TEXT_ARTICLES_GROUP_ACCESS','Nouvel article');
define('EDIT_TEXT_ARTICLES_GROUP_ACCESS','Éditez l\'article');
define('TEXT_ARTICLES_GROUP_ACCESS','Accès de groupe');
define('ARTICLES_GUEST', ' Invité');
define('ARTICLES_SHOW', ' Exposition');
define('ARTICLES_HIDE', ' Peau');
