...
define('TEXT_PUSH_SAVE_OPTION','Sauf des options');
define('TEXT_PUSH_WARNING','Avertissement : l\'opération peut chronométrer dehors si c\'est un niveau supérieur et vous avez un grand nombre de produits.');
?>