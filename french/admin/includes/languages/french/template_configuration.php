...
*/
define('ERROR4', 'Erreur ! erreur de 04 unkown');
define('TEMPLATE_ERROR_1', 'Erreur ! 01 le nom de calibre n\'est pas identiques comme le dossier de .sql ou le dossier de SQL n\'est pas présent');
define('HEADING_TITLE', 'Gestion Des Templates ');
define('TEMPLATE_ERROR_2', 'Erreur ! 02 elle des apears vous ne font installer aucun calibre');
...
define('ERROR1', 'Erreur ! 01 le nom de calibre n\'est pas identiques comme le dossier de .sql ou le dossier de SQL n\'est pas présent');
define('ERROR3', 'Erreur ! 03 vous ne pouvez pas installer le calibre de défaut, désolé');

define('TEMPLATE_NAME', 'Template Name:');
define('ERROR_NO_DELETE','Vous n\'êtes pas autorisé &eacute; supprimer le modèle par défaut du site.');
define('TEMPLATE_ERROR_3', 'Erreur ! 03 vous ne pouvez pas installer le calibre de défaut, désolé');
