...
define('TEXT_NO_PRODUCTS', 'Aucuns produits');
...
define('TEXT_EVENT_OSC_LINK_HELP', '(lien à un fabricant spécifique, à une catégorie, à un produit ou à un produit prochain)');
...
define('TEXT_EVENTS_DELETE_CONFIRM', 'Sure vous voulez supprimer tous les événements avant<b>'.(isset($before) && ($before != '') ? $before : '').'</b>?');
