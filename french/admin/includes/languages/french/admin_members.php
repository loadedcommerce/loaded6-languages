...
define('HEADING_TITLE_GROUPS', 'Groupes administration');
define('HEADING_TITLE_DEFINE', 'Set Menu and File Access by Group');
define('HEADING_TITLE_MEMBERS', 'Membres administration');
...
define('TEXT_INFO_DEFAULT_GROUPS_INTRO', '<b>NOTE :</b><ul><li><b>Editer :</b> Edite le nom du groupe.</li><li><b>Effacer :</b> Efface le groupe.</li><li><b>D&eacute;finir :</b> D&eacute;finit les acc&egrave;s du groupe.</li></ul>');
...
define('TEXT_INFO_DEFINE_INTRO_1', '<b>%s:</b><br>You can not change file permission for this group.<br><br>');
define('TEXT_INFO_DEFINE_INTRO', '<b>%s:</b><br>Change permission for this group by selecting or unselecting boxes and files provided. Click <b>insert</b> to save the changes.<br>');
define('TEXT_INFO_DEFINE_TYPE', '<tr><td><i><b>Note:</b><br>Black letters and a white back ground is Menu Access.</i></tr><tr><td><br><i>Black letters and light grey back ground is File Access </i></td></tr>');

define('TEXT_INFO_HEADING_EDIT_GROUP', 'Edit Group');
define('IMAGE_FILE_PERMISSIONS', 'Permissions de dossier'); 
?>