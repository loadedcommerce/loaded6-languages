...
define('TEXT_HELP_HELP1', '1. Click on the file name to edit.');
...
define('TEXT_HELP_HELP5', '4. Click on return button to return to main Edit Language Define screen.');
...
define('TEXT_SET_LANGUAGE', 'Choose Language to edit: ');
define('TEXT_SET_ADMIN_CAT', 'Look at Catalog or Admin file: ');
...
define('ERROR_CANNOT_RESTORE_FILE', 'Cant restore file, one paramiter is missing');
