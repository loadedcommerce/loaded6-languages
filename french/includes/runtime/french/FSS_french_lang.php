<?php
/*
  $Id: FSS_french_lang.php,v 1.0.0 2008/05/22 13:41:11 Eversun Exp $
...
*/ 
define('FSS_ACCOUNT_UPDATE_WARNING', 'Veuillez mettre à jour votre compte. Nous avons apporté des modifications à votre profil de compte que votre attention est nécessaire.');
define('FSS_HEADING_FORMS_AND_SURVEY', 'Mes formes et aperçus');
define('FSS_TEXT_UPDATE_ADDITIONAL_INFO', 'Mettez à jour les informations supplémentaires sur mon compte');
define('FSS_TEXT_UNCOMPLETED_SURVEYS', 'Enquêtes inachevées de vue');
define('FSS_TEXT_COMPLETED_SURVEYS', 'Regardez mes aperçus réalisés');
