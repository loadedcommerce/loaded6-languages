...
*/
  ...
  define('MODULE_ORDER_TOTAL_COUPON_TITLE', 'Coupon r&eacute;duction'); //apparait dans la validation de commande
...
//  define('TEXT_ENTER_COUPON_CODE', 'Enter Redeem Code&nbsp;&nbsp;');
  define('IMAGE_REDEEM_VOUCHER', 'Racheter un Coupon Cr&eacute;dit');
?>