...
define('NAVBAR_TITLE', 'Affiliate Help');
define('TEXT_INFO_HEADING_NEW_INFOBOX', 'Affiliate Help');
...
// 10
define('TEXT_COMMISSION_HELP', '<b>Total Commission</b>  Repr&eacute;sente la commission totale qui vous est d&ucirc;e');
...
//sales
// 15
define('TEXT_DATE_HELP_SALE', '<i>Date</i> represents the date of the sale.');
// 16
define('TEXT_TIME_HELP_SALE', '<i>Time</i> represents the time of the sale.');
// 17
define('TEXT_SALE_VALUE_HELP_SALE', '<i>Sale Value</i> represents the value of the sale.');
// 18
define('TEXT_COMMISSION_RATE_HELP_SALE', '<i>Commission Rate</i> represents the commission rate paid on the sale.');
// 19
...
// 23
define('TEXT_PAYMENT_STATUS_HELP', '<i>Payment Status</i> represents the status of the payment made to the affiliate');
// 24
define('TEXT_PAYMENT_DATE_HELP', '<i>Date</i> represents the date of the payment.');

if (!defined('TEXT_CLOSE_WINDOW')) {
define('TEXT_CLOSE_WINDOW', 'Fenêtre étroite [x]');
}
?>
