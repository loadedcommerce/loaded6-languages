...
define('CROSS_SELL_SUCCESS', 'Querverweisprodukte wurden erfolgreich aktualisiert #'.(isset($_GET['add_related_product_ID']) ? $_GET['add_related_product_ID'] : 0));
define('SORT_CROSS_SELL_SUCCESS', 'Sortierreihenfolge wurde aktualisiert f&uuml;r Querverweisprodukte #'.(isset($_GET['add_related_product_ID']) ? $_GET['add_related_product_ID'] : 0));
