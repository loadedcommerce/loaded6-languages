...
*/
define('TABLE_HEADING_EDIT_ORDERS', 'Zu den Auftrag ändern');

define('HEADING_TITLE', 'Bestellungen');
define('HEADING_IS_TITLE', 'IST Auftrag');
define('HEADING_IS_RECEIPT', 'IST der Empfang');
...
define('ENTRY_CREDIT_CARD_START','D&ampdatum; eacute; Teil CB');
...
define('ENTRY_PAYMENT_TRANS_ID', 'Verhandlung Identifikation: ');  
// Email Subject 
...
define('TABLE_HEADING_PRODUCTS_VENDOR', 'Verkäufer');
define('TABLE_HEADING_QUANTITY', 'Menge');
define('TABLE_HEADING_VENDORS_SHIP', 'Verlader');
define('TABLE_HEADING_SHIPPING_METHOD', 'Methode');
define('TABLE_HEADING_SHIPPING_COST', 'Schiffskosten');
define('VENDOR_ORDER_SENT', 'Aufträge geschickt zu ');
?>