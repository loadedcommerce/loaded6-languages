...
define('NEW_TEXT_ARTICLES_GROUP_ACCESS','Neuer Artikel');
define('EDIT_TEXT_ARTICLES_GROUP_ACCESS','Redigieren Sie Artikel');
define('TEXT_ARTICLES_GROUP_ACCESS','Gruppen-Zugang');
define('ARTICLES_GUEST', ' Gast');
define('ARTICLES_SHOW', ' Erscheinen');
define('ARTICLES_HIDE', ' Fell');
