...
define('NEW_TEXT_FAQ_CATEGORIES_GROUP_ACCESS','New Article');
define('EDIT_TEXT_FAQ_CATEGORIES_GROUP_ACCESS','Edit Article');
define('TEXT_FAQ_CATEGORIES_GROUP_ACCESS','Group Access');
define('FAQ_CATEGORIES_GUEST', ' Guest');
define('FAQ_CATEGORIES_SHOW', ' Show');
define('FAQ_CATEGORIES_HIDE', ' Hide');
...
define('TEXT_PUSH_SUB_CATEGORIES','Push access to all faq categories');
define('TEXT_PUSH_SUB_CATEGORIES_PRODUCTS','Push access to all faq categories and faq\'s');
define('TEXT_PUSH_WARNING','Warning : may time out if this is a top level and you have a large number of faq categories and faq\'s');
?>
