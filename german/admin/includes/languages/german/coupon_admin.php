...
define('TEXT_TO_REDEEM_TEXT', 'Sie k&ouml;nnen diesen Kupon bei der Kasse einl&ouml;sen. ' . "\n" . '%s' . "\n\n" . 'Geben Sie nur den Code aus der Box ein, und klicken Sie den Einl&ouml;sen Button.');
...
define('TEXT_TO_REDEEM1', 'Sie können diesen Diskontkupon während der Prüfung auch zurückkaufen. Geben Sie einfach den Code im bereitgestellten Kasten, ein und klicken Sie an den zurückkaufenknopf.');
define('COUPON_SALE_EXCLUDE_HELP', 'Dieser Kupon trifft nicht auf irgendein Einzelteil zu, das als markiert wird, seiend auf Verkauf.');
define('COUPON_SALE_EXCLUSION', 'Kupon-Verkaufs-Ausschluss');
