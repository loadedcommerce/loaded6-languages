...
$backups="<a class='adminLink' href='".tep_href_link(FILENAME_BACKUP)."'>Datenbank sichern</a>";
define('BLOCK_CONTENT_STORE_INFO_STORE_BACKUPS',$backups); 
define('BLOCK_TITLE_COMPONENTS', 'Produkt-Ausrichtung');
define('BLOCK_TEXT_EMPTY_COMPONENTS', 'Leere Bestandteiltabelle');
// Store tips
...
define('BLOCK_CONTENT_OT_THIS_MONTH','# of Orders Approved:<br>This month: ');
define('BLOCK_CONTENT_OT_TODAY_SO_FAR','Todays Orders so far: ');
define('BLOCK_CONTENT_OT_MONTH_AVG_AMOUNT', 'Month\'s Average so far: ');
