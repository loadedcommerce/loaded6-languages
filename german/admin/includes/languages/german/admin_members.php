...
define('HEADING_TITLE_GROUPS', 'Admin Gruppen');
define('HEADING_TITLE_DEFINE', 'Set Menu and File Access by Group');
define('HEADING_TITLE_MEMBERS', 'Admin Mitglieder');
...
define('TEXT_INFO_DEFAULT_GROUPS_INTRO', '<b>ACHTUNG:</b><ul><li><b>&Auml;ndern::</b> Name der Gruppe &auml;ndern.</li><li><b>L&ouml;schen:</b> Gruppe l&ouml;schen.</li><li><b>Definieren:</b> Gruppenzugang definieren.</li></ul');
...
define('IMAGE_FILE_PERMISSIONS', 'Akten-Erlaubnis'); 
?>