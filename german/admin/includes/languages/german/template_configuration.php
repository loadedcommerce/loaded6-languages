...
*/
define('ERROR4', 'Störung! 04 unkown Störung');
define('TEMPLATE_ERROR_1', 'Störung! 01 der Schablonenname ist nicht die selben, die die .sql Akte oder die sql-Akte nicht anwesend ist');
define('HEADING_TITLE', 'Template Verwaltung');
define('TEMPLATE_ERROR_2', 'Störung! 02 lässt sie apears Sie keine Schablonen anbringen');
...
define('ERROR1', 'Störung! 01 der Schablonenname ist nicht die selben, die die .sql Akte oder die sql-Akte nicht anwesend ist');
define('ERROR3', 'Störung! 03 können Sie die Rückstellungsschablone nicht anbringen, traurig');

define('TEMPLATE_NAME', 'Template Name:');
define('ERROR_NO_DELETE','Sie sind nicht erlaubt zu löschen Site Standard-Template.');
define('TEMPLATE_ERROR_3', 'Störung! 03 können Sie die Rückstellungsschablone nicht anbringen, traurig');
