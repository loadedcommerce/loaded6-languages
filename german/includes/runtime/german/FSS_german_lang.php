<?php
/*
  $Id: FSS_german_lang.php,v 1.0.0 2008/05/22 13:41:11 Eversun Exp $
...
*/ 
define('FSS_ACCOUNT_UPDATE_WARNING', 'Aktualisieren Sie bitte Ihr Konto. Wir haben Änderungen an Ihrem Kundenprofil vorgenommen, das Ihre Aufmerksamkeit erforderlich ist.');
define('FSS_HEADING_FORMS_AND_SURVEY', 'Meine Formen und Übersichten');
define('FSS_TEXT_UPDATE_ADDITIONAL_INFO', 'Aktualisieren Sie die zusätzliche Information über mein Konto');
define('FSS_TEXT_UNCOMPLETED_SURVEYS', 'Ansicht-unvollständige Übersichten');
define('FSS_TEXT_COMPLETED_SURVEYS', 'Sehen Sie meine abgeschlossenen Übersichten an');
