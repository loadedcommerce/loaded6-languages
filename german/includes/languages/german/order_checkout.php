...
define('HEADING_TITLE_COMMENTS', 'Add comments about your order');
define('CONDITION_AGREEMENT', 'I have read the <a href="pages.php?pID=1" target="_blank">conditions of use</a> and I agree to them');
define('TEXT_ORDER_CHECKOUT_PROCESSING', 'Processing transaction');
define('TEXT_ORDER_CHECKOUT_DESCRIPTION_PROCESSING', 'If this page appears for more than 5 seconds, please click the Checkout button to complete your order.');
...
define('CHECKOUT_BAR_CHECKOUT', 'Checkout');

define('TEXT_ORDER_TOTAL_ZERO','Felicidades! Su pedido total es cero, por favor seleccione para confirmar continuar.');
?>