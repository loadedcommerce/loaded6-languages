...
//please change the pID=1 to the ID number for your condition in the information system
define('CONDITION_AGREEMENT', 'Ich habe gelesen <a href="pages.php?pID=1" target="_blank">Zustände des Gebrauches</a> und ich stimme ihnen zu.');
define('CONDITION_AGREEMENT_WARNING', 'Lesen Sie bitte unsere Zustände des Gebrauches und stimmen Sie ihnen zu. Wenn Sie nicht zustimmen, können wir nicht an Sie liefern.');   
?>