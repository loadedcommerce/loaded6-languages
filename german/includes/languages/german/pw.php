...
define('TEXT_ACCOUNT_B2BWARNING','Thank you for creating an account in our store. We validate account access. We will review your information and contact you if necessary. If we approve your account, you will receive a notification via email');
?>