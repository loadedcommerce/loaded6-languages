...
define('EMAIL_GREET_NONE', 'Hallo ' . stripslashes($_POST['firstname']) . ',' . "\n\n");
...
define('HEADING_TITLE_CHECKOUT','Prüfungs-persönliches Info');// Added by sheetal for PWA form Title
